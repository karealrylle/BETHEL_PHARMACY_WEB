...
$default_message = $message ? $message : 'Enter your new password.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Bethel Pharmacy - Reset Password</title>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <button name="reset_password" type="submit" class="btn-submit">Reset Password</button>
