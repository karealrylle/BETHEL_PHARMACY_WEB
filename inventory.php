...
$activity_query = "SELECT 
    ...
    p.category,
    pb.batch_number,
    COALESCE(u.username, CONCAT('User ID: ', bm.performed_by)) as username,
    NULL as sale_id,
        ...
        <div class="content">
            ...
            <div class="inventory-header">
                ...
                <a href="update_stock.php" class="update-stock-btn">
                    <img src="assets/pencil.png" alt="Edit" style="width: 16px; height: 16px; ">
                      Update Stock
                </a>
            </div>
            ...
            <div class="inventory-boxes">
                ...
                <div class="inventory-box-inner">
                    ...
                    <a href="notifications.php?filter=critical" class="inventory-box-view">View Details »</a>
                </div>
